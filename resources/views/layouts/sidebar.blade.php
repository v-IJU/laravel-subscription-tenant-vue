                            ...
                            @foreach ($menu['group'] as $group)
                                <li>
                                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                                        ...
                                        <span key="t-dashboards">{{ $group['name'] }}</span>
                                    </a>
                                    @if (isset($group['menu']) && count((array) $group['menu']) > 0)
                                        <ul class="sub-menu" aria-expanded="false">
                                            @foreach ($group['menu'] as $menuGroup)
                                                @if ($menuGroup['is_url'] == 0)
                                                    <li><a href="{{ Route::has($menuGroup['url']) ? route($menuGroup['url']) : '#' }}"
                                                            key="t-default">{{ $menuGroup['name'] }}</a></li>
                                                @else
                                ...
                                @if ($menus['is_url'] == 0)
                                    <li>
                                        <a href="{{ Route::has($menus['url']) ? route($menus['url']) : '#' }}"
                                            ...
                                            <span key="t-yajra-datatable">{{ $menus['name'] }}</span>
                                        </a>
                                    </li>
                                @else
                                    <li>
