<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex ">
            <!-- LOGO -->
            <div class="navbar-brand-box d-none d-lg-inline-block">
                <div class="position-relative">
                    <a href="{{ route('backenddashboard') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('build/images/logo_small_size.png') }}" alt="" height="35">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ URL::asset('build/images/logo_small_size.png') }}" alt=""
                                height="35">
                        </span>
                    </a>
                </div>
                <div class="position-relative">
                    <a href="{{ route('backenddashboard') }}" class="logo logo-light mt-3">
                        <span class="logo-lg">
                        ...
                        <a href="{{ route('backenddashboard') }}">
                            <h4 class="fs-3 text-white">
                                {{ isset(Configurations::getConfig('site')->site_name) ? Str::limit(Configurations::getConfig('site')->site_name, 6) : 'Tailor' }}
                            </h4>
                        </a>
            ...
            <button type="button" class="btn btn-sm px-3 pt-5 font-size-16 header-item waves-effect" id="vertical-menu-btn">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect">
                    ...
                    <a href="{{ route('home') }}" target="_blank"><i class="fa fa-globe fs-4"></i></a>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="{{ isset(Auth::user()->images) ? asset(Auth::user()->images) : asset('build/images/users/user-dummy-img.jpg') }}"
                        alt="Header Avatar">
                    <span class="d-xl-inline-block ms-1" key="t-henry">{{ ucfirst(Auth::user()->username) }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item d-block d-none" href="javascript:void(0)" data-bs-toggle="modal"
