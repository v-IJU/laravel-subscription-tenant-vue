...
@section('content')
    ...
    <div id="admin-role-page">
        ...
        <div class="card">
            <div class="card-body">
                {{ Form::open(['role' => 'form', 'route' => ['do_menu_assign_from_admin'], 'method' => 'post', 'class' => 'form-horizontal form-label-left', 'id' => 'role-form']) }}
                <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-3">
                                                <fieldset>
                                                    ...
                                                    {!! Form::checkbox(
                                                        ...
                                                        '1',
                                                        @$permission[$group->id][$values->id] == 1 || $group->id == 1 ? true : false,
